 ...
 */
@Path("/beers")
public interface TestBeersResource {
  /**
   * <p>
  ...
  TestBeer getBeer(@PathParam("beerId") @Positive(message = "The beerId must be a natural number!") int beerId);
  ...
  @POST
  @Consumes("application/json")
  void addBeer(@NotNull TestBeer data);
}
