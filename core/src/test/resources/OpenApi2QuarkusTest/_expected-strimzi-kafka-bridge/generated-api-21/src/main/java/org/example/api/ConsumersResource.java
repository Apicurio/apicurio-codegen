...
public interface ConsumersResource {
   ...
   *
   */
  @Operation(description = "Creates a consumer instance in the given consumer group. You can optionally specify a consumer name and supported configuration options. It returns a base URI which must be used to construct URLs for subsequent requests against this consumer instance.", operationId = "createConsumer")
  @Path("/{groupid}")
  @POST
   ...
   *
   */
  @Operation(description = "Configures a subscribed consumer to seek (and subsequently read from) the first offset in one or more given topic partitions.", operationId = "seekToBeginning")
   ...
   *
   */
  @Operation(description = "Configures a subscribed consumer to seek (and subsequently read from) the offset at the end of one or more of the given topic partitions.", operationId = "seekToEnd")
   ...
   *
   */
  @Operation(description = "Retrieves a list of the topics to which the consumer is subscribed.", operationId = "listSubscriptions")
   ...
   *
   */
  @Operation(description = "Subscribes a consumer to one or more topics. You can describe the topics to which the consumer will subscribe in a list (of `Topics` type) or as a `topic_pattern` field. Each call replaces the subscriptions for the subscriber.", operationId = "subscribe")
  @Path("/{groupid}/instances/{name}/subscription")
  @POST
  @Consumes("application/vnd.kafka.v2+json")
   ...
   *
   */
  @Operation(description = "Unsubscribes a consumer from all topics.", operationId = "unsubscribe")
  @Path("/{groupid}/instances/{name}/subscription")
  @DELETE
   ...
   *
   */
  @Operation(description = "Configures a subscribed consumer to fetch offsets from a particular offset the next time it fetches a set of records from a given topic partition. This overrides the default fetch behavior for consumers. You can specify one or more topic partitions.", operationId = "seek")
   ...
   *
   */
  @Operation(description = "Assigns one or more topic partitions to a consumer.", operationId = "assign")
   ...
   *
   */
  @Operation(description = "Retrieves records for a subscribed consumer, including message values, topics, and partitions. The request for this operation MUST use the base URL (including the host and port) returned in the response from the `POST` request to `/consumers/{groupid}` that was used to create this consumer.", operationId = "poll")
   ...
   *
   */
  @Operation(description = "Deletes a specified consumer instance. The request for this operation MUST use the base URL (including the host and port) returned in the response from the `POST` request to `/consumers/{groupid}` that was used to create this consumer.", operationId = "deleteConsumer")
   ...
   *
   */
  @Operation(description = "Commits a list of consumer offsets. To commit offsets for all records fetched by the consumer, leave the request body empty.", operationId = "commit")
